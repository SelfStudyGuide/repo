...
@Service
public class GetHomeworkDetailsActionHandler implements
		ActionHandler<GetHomeworkDetailsResponse, GetHomeworkDetails> {

	@Autowired
	private StudentService service;

	public GetHomeworkDetailsResponse execute(GetHomeworkDetails action)
			throws SsgGuiServiceException {
		return new GetHomeworkDetailsResponse(
				service.getHomeworksDetails(action.getHomeworkId()));
	}
